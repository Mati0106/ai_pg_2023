...
# We can see that our feature values are very imbalanced,
# with vast majority of bad wines. For imbalanced datasets, boost or tree-based models are usually a very good choice.
